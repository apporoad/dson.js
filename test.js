...
it('test basic', async () =>{
	...
	expect(masks10.sum1).toBe(10)
	expect(masks10.avg1 > 3).toBeTruthy()
	expect(masks10.max1).toBe(5)
	expect(masks10.min1).toBe(2)
	expect(masks10.sum1 == masks10.sum2).toBeTruthy()
